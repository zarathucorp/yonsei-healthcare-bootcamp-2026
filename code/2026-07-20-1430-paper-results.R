...
# 차시: 논문용 분석결과 만들기: 분석 -> 테이블(xlsx), 편집가능한 그림(pptx) -> Statistical Analysis 작성 -> docx 문서
# 날짜: 2026.07.20 14:30 ~ 15:30
# 강사: 김진섭
...
# 4. 결과 저장 ---------------------------------------------------------------
# writexl::write_xlsx(list(result = result), "results/2026-07-20-1430-paper-results-result.xlsx")
