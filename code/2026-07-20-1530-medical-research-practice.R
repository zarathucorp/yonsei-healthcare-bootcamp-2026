...
# 차시: 실습: 예시데이터 및 R/AI agent 이용하여 데이터 정리, 분석, 테이블/그림, Statistical Analysis, docx 문서 만들기
# 날짜: 2026.07.20 15:30 ~ 16:00
# 강사: 김진섭
...
# 4. 결과 저장 ---------------------------------------------------------------
# writexl::write_xlsx(list(result = result), "results/2026-07-20-1530-medical-research-practice-result.xlsx")
