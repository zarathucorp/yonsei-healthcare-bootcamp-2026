...
# 차시: RCT 가 최고인 이유, 그러나 하기 어려운 이유, NEJM/Lancet/JAMA RCT 에 이용된 통계방법 리뷰
# 날짜: 2026.07.21 09:30 ~ 10:30
# 강사: 김진섭
...
# 4. 결과 저장 ---------------------------------------------------------------
# writexl::write_xlsx(list(result = result), "results/2026-07-21-0930-rct-intro-result.xlsx")
