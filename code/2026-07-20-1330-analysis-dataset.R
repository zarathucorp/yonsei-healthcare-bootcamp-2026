...
# 차시: 분석용 데이터만들기: 데이터 읽기 -> 결측/이상치 처리 -> 쓸 변수만 정리 -> 숫자/범주형 지정 -> 변수 Label 설정
# 날짜: 2026.07.20 13:30 ~ 14:30
# 강사: 김진섭
...
# 4. 결과 저장 ---------------------------------------------------------------
# writexl::write_xlsx(list(result = result), "results/2026-07-20-1330-analysis-dataset-result.xlsx")
