...
# 차시: 분석 옵션 설정 및 R 패키지 다운로드, 이후 Mimic CDM에서 패키지 실행
# 날짜: 2026.07.22 15:30 ~ 16:00
# 강사: 김진섭
...
# 4. 결과 저장 ---------------------------------------------------------------
# writexl::write_xlsx(list(result = result), "results/2026-07-22-1530-cdm-r-package-result.xlsx")
